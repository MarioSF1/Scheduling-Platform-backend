...
import com.Scheduling.Platform.application.services.StoreService;
...
public class StoreController {
    ...
    public ResponseEntity<Store> create(@RequestBody StoreRequest request, Authentication authentication) {
        ...
        return ResponseEntity.status(HttpStatus.CREATED).body(storeService.createStore(request, email));
    }
}
